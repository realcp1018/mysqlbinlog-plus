...
func initAll() {
	...
	rootCmd.Flags().BoolVarP(&cfg.ListBinlogs, "list-binlogs", "L", false, "list online binlog files and exit")
	rootCmd.Flags().StringSliceVarP(&cfg.Binlogs, "binlogs", "B", nil, "binlogs to parse")
